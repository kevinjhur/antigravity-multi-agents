...
```powershell
# 예: 전체 공정 실행
powershell -ExecutionPolicy Bypass -File .antigravity/scripts/c8051_build.ps1 -Action all

# 예: 펌웨어만 업로드
powershell -ExecutionPolicy Bypass -File .antigravity/scripts/c8051_build.ps1 -Action up
```
